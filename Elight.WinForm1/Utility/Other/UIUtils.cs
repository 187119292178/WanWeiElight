...
namespace Elight.Utility.Other
{
    ...
    public static class UIUtils
    {
        ...
        public delegate void InvokeLightStateDelegate(UILight light, UILightState state);

        public static void InvokeLightState(this UILight light, UILightState state)
        {
            if (light.InvokeRequired)
            {
                light.BeginInvoke(new InvokeLightStateDelegate(InvokeLightState), new object[] { light, state });
            }
            else
            {
                light.State = state;
