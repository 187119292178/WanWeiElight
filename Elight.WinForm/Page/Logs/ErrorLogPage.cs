...
namespace Elight.WinForm.Page.Logs
{
    ...
    /// </summary>
    [PageCode("log-error")]
    public partial class ErrorLogPage : MyPage
    {
        ...
        private void btnQuery_Click(object sender, EventArgs e)
        {
            //查询日志  
            int totalCount = 0;
            List<SysLog> list = logic.GetList(pagination.ActivePage, pagination.PageSize, Type, Convert.ToString(buttonId), txtKeywords.Text, ref totalCount);
        ...
        private void btnExport_Click(object sender, EventArgs e)
        {
            ...
            string baseDirPath = MyEnvironment.RootPath("\\Log\\Error\\");
        ...
        private void FileDownloadUtils_ErrorHandler(object sender, Exception ex)
        {
            this.ShowInfoDialog("网络或服务器异常，下载失败", UIStyle.White);
        }

        private void FileDownloadUtils_EndHandler(object sender)
        {
            this.ShowSuccessDialog("下载完成", UIStyle.White);
        }
